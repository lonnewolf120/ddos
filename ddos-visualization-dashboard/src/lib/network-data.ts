...
export const RED_TEAM_VMS: VMNode[] = [
  // COMMENTED OUT - Red Team VMs without OPNsense LAN IP
  // {
  //   id: "scheduler",
...
export const BLUE_TEAM_VMS: VMNode[] = [
  // COMMENTED OUT - Blue Team 1 (Hidden for now)
  // {
  //   id: "team1",
  //   name: "Blue Team 1",
  //   ip: "20.10.40.11",
  ...
  //   status: "online",
  //   services: [
  //     { name: "bWAPP", port: 9080, status: "running" },
  //     { name: "DVWA", port: 9090, status: "running" },
  ...
  //   role: "Wazuh",
  //   status: "online",
  //   services: [{ name: "Wazuh", port: 5601, status: "running" }],
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Nginx Proxy", port: 3000, status: "running" },
  ...
  // COMMENTED OUT - Blue Team 3 (Hidden for now)
  // {
  //   id: "team3",
  //   name: "Blue Team 3",
  //   ip: "20.10.60.11",
